...
void Graph::AddNode(Node* node, int index)
{
    ...
    try {
        ...
        std::cout << "Graph::AddNode(): could not allocate node...\n" << flush;
        exit(0);
...
void Graph::DFS(std::vector<Color>& color, vector<int>& pi, int u) {
